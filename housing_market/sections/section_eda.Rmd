...
Looking at the distribution of the variables of the dataset, we can settle on the scale, on which the _median home value_ is measured, which is **1000 USD**.
...
Other than a few very weak positive correlations between the variables, only one stands out significantly, which is the correlation between _median home value_ and _average rooms_ with a correlation coefficient of $0.8884$.
...
Also, the correlation of _average rooms_ and _median home value_ remains almost the same.
